...
function ProgressBar({ step }: { step: number }) {
  const progress = step / 4; // 4 question steps before result
  return (
      ...
      <View style={styles.tabRow}>
        ...
        >
          <Ionicons
            ...
            size={28}
            color={selected === 'retro' ? Colors.primary : Colors.textSecondary}
          />
          <Text style={[styles.tabText, selected === 'retro' && styles.tabTextActive]}>
            Retrospectives
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Ionicons
            name="snow-outline"
            size={28}
            color={selected === 'icebreaker' ? Colors.primary : Colors.textSecondary}
          />
          <Text style={[styles.tabText, selected === 'icebreaker' && styles.tabTextActive]}>
            Icebreakers
          </Text>
        </TouchableOpacity>
      </View>
          ...
          >
            ...
            <Text
              style={[
                ...
                selected === opt.value && styles.circleOptionTextActive,
              ]}
            >
              {opt.label}
            </Text>
          ...
          >
            ...
            <Text
              style={[
                ...
                selected === opt.value && styles.listOptionTextActive,
              ]}
            >
              {opt.label}
            </Text>
...
function StepMood({
  ...
  const options = [
    { value: 'fun', label: 'Fun et leger', icon: 'happy-outline', emoji: '🎉' },
    { value: 'serious', label: 'Serieux et structure', icon: 'briefcase-outline', emoji: '📋' },
    { value: 'creative', label: 'Creatif et innovant', icon: 'bulb-outline', emoji: '💡' },
  ];
          ...
          >
            ...
            <Text
              style={[
                ...
                selected === opt.value && styles.moodOptionTextActive,
              ]}
            >
              {opt.label}
            </Text>
      ...
      <View style={styles.resultCard}>
        <View
          style={[
            ...
            {
              backgroundColor:
                activity.type === 'retro' ? Colors.primaryLight : '#e6f7f3',
            },
          ]}
        >
          <Text
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>
            {step === 'result' ? 'Resultat' : 'Trouve ton booster'}
          </Text>
          <View style={styles.backBtn} />
        </View>
