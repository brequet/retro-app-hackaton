...
export default function ActivityDetailScreen() {
  ...
  const handleClone = async () => {
    try {
      ...
      useToastStore.getState().show("Activité clonée !", "success");
  ...
  const typeColor =
    activity.type === "retro" ? Colors.retro : Colors.icebreaker;
  const typeBg =
    activity.type === "retro" ? Colors.primaryLight : Colors.accentLight;
          ...
          <View style={styles.section}>
            ...
            {activity.materials.map((material, index) => (
              <View key={index} style={styles.materialRow}>
                <View
                  style={[styles.materialDot, { backgroundColor: typeColor }]}
                />
