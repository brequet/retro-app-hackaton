...
export default function CreateActivityScreen() {
  ...
  React.useEffect(() => {
    if (isEdit && existingActivity && !initialized) {
      ...
      setInstructions(
        existingActivity.instructions.length > 0
          ? existingActivity.instructions
          : [""],
      );
      setMaterials(
        existingActivity.materials.length > 0
          ? existingActivity.materials
          : [""],
      );
      ...
      const dOpt = DURATION_OPTIONS.find(
        (d) =>
          d.min === existingActivity.duration_min &&
          d.max === existingActivity.duration_max,
      );
      ...
      const tOpt = TEAM_SIZE_OPTIONS.find(
        (t) =>
          t.min === existingActivity.team_size_min &&
          t.max === existingActivity.team_size_max,
      );
  ...
  const handleAiGenerate = async () => {
    ...
    try {
      ...
      setInstructions(
        result.instructions.length > 0 ? result.instructions : [""],
      );
      ...
      showToast(
        "Retrospective generee ! Tu peux modifier le contenu avant de sauvegarder.",
        "success",
      );
    } catch (e: unknown) {
      const message =
        e instanceof Error ? e.message : "Erreur lors de la generation";
  ...
  const validate = (): string | null => {
    ...
    if (validInstructions.length === 0)
      return "Ajoute au moins une instruction";
    return null;
  };
      ...
      >
        ...
        >
          ...
          <View style={styles.typeRow}>
            ...
            >
              ...
              <Text
                style={[
                  styles.typeBtnText,
                  type === "retro" && styles.typeBtnTextActive,
                ]}
              >
                Retrospective
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.typeBtn,
                type === "icebreaker" && styles.typeBtnActiveIce,
              ]}
            ...
            >
              <Ionicons
                ...
                size={22}
                color={
                  type === "icebreaker" ? Colors.white : Colors.textSecondary
                }
              />
              <Text
                style={[
                  styles.typeBtnText,
                  type === "icebreaker" && styles.typeBtnTextActive,
                ]}
              >
                Icebreaker
              </Text>
              ...
              {!showAiSection ? (
                ...
                <View style={styles.aiCard}>
                  ...
                  <Text style={styles.aiCardDescription}>
                    Entre un theme et l'IA generera un format de retrospective
                    original avec titre, description, instructions et materiel.
                  </Text>

                  <View style={styles.aiInputRow}>
                    <TextInput
                      style={[styles.textInput, styles.aiInput]}
                      placeholder="Ex: 'Communication d'équipe', 'Pâques et chocolat'..."
                      placeholderTextColor={Colors.textTertiary}
                      value={aiTheme}
                    ...
                    <View style={styles.aiButtonsRow}>
                      ...
                      {aiGenerated && (
                        <Text style={styles.aiHint}>
                          Le formulaire a ete pre-rempli. Tu peux le modifier
                          librement.
                        </Text>
                      )}
                    </View>
            ...
            <View style={styles.chipRow}>
              {DURATION_OPTIONS.map((opt) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.chip,
                    duration.value === opt.value && styles.chipActive,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.chipText,
                      duration.value === opt.value && styles.chipTextActive,
                    ]}
                  >
                    {opt.label}
                  </Text>
            ...
            <View style={styles.chipRow}>
              {TEAM_SIZE_OPTIONS.map((opt) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.chip,
                    teamSize.value === opt.value && styles.chipActive,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.chipText,
                      teamSize.value === opt.value && styles.chipTextActive,
                    ]}
                  >
                    {opt.label}
                  </Text>
            ...
            <View key={index} style={styles.listItemRow}>
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      type === "retro" ? Colors.retro : Colors.icebreaker,
                  },
                ]}
              />
              <TextInput
          ...
          <View style={styles.submitRow}>
            <Button
              title={
                isEdit ? "Enregistrer les modifications" : "Creer l'activite"
              }
